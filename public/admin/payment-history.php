...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"Update payments set paid='$paid',balance='$balance'
     WHERE patientID='$vid' AND id='".$_POST['invoice']."' ");
    if($query)
    {
...
<html lang="en">
	<head>
		<title>Records | Payment History</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Records | Payment History</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Records</span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Payment <span class="text-bold">History</span></h5>
...
<p align="center">
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Add Deposit</button></p>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <h5 class="modal-title" id="exampleModalLabel">Add Deposit</h5>
      ...
      <tr>
        <th>Invoice :</th>
        <td>
          <select name="invoice" class="span8 tip"  required
           style="width:450px;
                  border-radius:15px;
                  padding-top:10px;
                  padding-bottom:10px;">
        	<option value="">Select Invoice</option>
        	<?php $query=mysqli_query($con,"SELECT * FROM payments WHERE PatientID='$vid' ");
  ...
  <?php }?>
    ...
    <input name="paid" placeholder="Deposit Amount" class="form-control wd-450" required></td>
  </tr>
