        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6><a href="add-category.php" class="btn btn-o btn-primary">
              Add Category</a>
              </h6>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <?php $query=mysqli_query($con,"select * from categories");
                    ...
                    <tr>
                      ...
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo htmlentities($row['cat_title']);?></p>
                      </td>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="edit-category.php?id=<?php echo $row['cat_id'];?>" class="badge badge-sm bg-gradient-secondary" data-toggle="tooltip" data-original-title="Edit Category">
                          Edit
                        </a>
                        <a href="categories.php?id=<?php echo $row['cat_id'];?>&del=delete" 
