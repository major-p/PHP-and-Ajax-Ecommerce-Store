  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span class="ms-1 font-weight-bold">AJ Lounge</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
		...
		<li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Drinks</h6>
        </li>
		<li class="nav-item">
          <a class="nav-link  " href="products.php">
            ...
            <span class="nav-link-text ms-1">Drinks</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  " href="add-product.php">
            ...
            <span class="nav-link-text ms-1">Add Drink</span>
          </a>
        </li>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quick Search</h6>
        </li>
        <li class="nav-item">
